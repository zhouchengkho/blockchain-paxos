...
//
func (ck *Clerk) Get(position int) string {
	// You will have to modify this function.
	ck.baseSeq++
	// key, client id, client seq
	args := &GetArgs{position, ck.id, ck.baseSeq}
...
//
func (ck *Clerk) PutAppend(position int, value string, op string) {
	// You will have to modify this function.
	ck.baseSeq++

	// key, value, op, client id, client seq
	args := &PutAppendArgs{position, value, op, ck.id, ck.baseSeq}
...
func (ck *Clerk) Put(position int, value string) {
	ck.PutAppend(position, value, "Put")
}
func (ck *Clerk) Append(position int, value string) {
	ck.PutAppend(position, value, "Append")
}
