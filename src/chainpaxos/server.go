...
func (kv *KVPaxos) Get(args *GetArgs, reply *GetReply) error {
	...
	operation := Op{args.Position, "", "Get", args.ClientId, args.ClientSeq}
...
func (kv *KVPaxos) PutAppend(args *PutAppendArgs, reply *PutAppendReply) error {
	...
	op := Op{args.Position, args.Value, args.Op, args.ClientId, args.ClientSeq}
...
// exported kill command for test purposes
func (kv *KVPaxos) Kill() {
	kv.kill()
}
